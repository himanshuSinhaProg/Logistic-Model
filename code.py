...
def init():
    ...
    df=pd.read_csv(r"C:\Users\12899\OneDrive - Durham College\Desktop\Breast-Cancer-Prediction-Using-Logistic-Regression-master\Breast-Cancer-Prediction-Using-Logistic-Regression-master\Data\data.csv") 
